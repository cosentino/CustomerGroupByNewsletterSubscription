...
class Gufo_CustomerGroupByNewsletterSubscription_Model_Subscriber extends Mage_Core_Model_Abstract
{
    ...
    //COSENTINOSHOP Presaldi (27/05/2016)
    //TODO: prevedere configurazione da admin di customer group per utenti iscritti/non iscritti alla newsletter
    const CUSTOMER_GROUP_ID_GENERAL_NEWSLETTER = 6;
    ...
    public function subscribeCustomer($customer)
    {
       ...
       if ($customer->isConfirmationRequired() && ($customer->getConfirmation() != $customer->getPassword())) {
        ...
        //BEGIN COSENTINOSHOP: Presaldi (27/05/2016)
        //effettuo qui il salvataggio del customer altrimenti va in loop
